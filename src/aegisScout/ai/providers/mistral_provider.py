...
Mistral can be slow on cold start; same 30s floor as DeepSeek.
...
MISTRAL_FLOOR_TIMEOUT_SECONDS: float = 30.0


class MistralProvider(BaseLLMProvider):
    """Mistral Chat Completions API provider."""
    ...
    def __init__(self):
        ...
        self.timeout_seconds = max(self._resolve_timeout(), MISTRAL_FLOOR_TIMEOUT_SECONDS)
    ...
    async def generate(
        ...
        **kwargs,
        ...
        payload: dict[str, Any] = {
            "model": kwargs.get("model", MISTRAL_DEFAULT_MODEL),
            "messages": messages,
